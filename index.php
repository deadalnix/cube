...
render_set(array(
	'All edges oriented' => array(
		...
		new Oll('T', "l U R' D R U' R' D' x", 4),
		new Oll('L', "l' U R D' R' U' R D x'", 4),
	...
	'Awkward shapes' => array(
		...
		new Oll('', "R2 U R' B' R U' R2 U R B R'", 4, "Do the B' with your right ring finger and the B with your right index finger."),
		new Oll('', "R U R' U R U2 R' F R U R' U' F'", 4),
		new Oll('', "l' U R U' R' U R U' l U R' U' R U R'", 4),
	),
	'L shapes' => array(
		new Oll('', "F R U R' U' R U R' U' F'", 4),
		new Oll('', "R' U' l' U R U' R' U R U' x' U R", 4),
